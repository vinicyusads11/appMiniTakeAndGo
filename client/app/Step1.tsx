...
const Step1 = () => {
  ...
  return (
    <View style={styles.step1}>
      ...
      <Pressable style={[styles.prximo, styles.prximoPosition]} onPress={() => router.push('/Step2')}>
        <Text style={[styles.prximo1, styles.prximo1Typo]}>PRÓXIMO</Text>
      </Pressable>
      <Pressable style={[styles.voltar, styles.prximoPosition]} onPress={() => router.push('/Welcome')}>

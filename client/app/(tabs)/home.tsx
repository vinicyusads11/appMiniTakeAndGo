...
const Home = () => {
  ...
  return (
    <View style={styles.home}>
      ...
      <Text style={[styles.restante4, styles.restanteFlexBox]}>Restante: 4</Text>
      ...
      <Text style={[styles.nossosProdutos, styles.nossosProdutosFlexBox]}>Nossos produtos!</Text>
      ...
      <Text style={[styles.cupNoodles, styles.cupNoodlesTypo]}>Cup Noodles</Text>

      <Text style={[styles.textoRestante6, styles.restanteTypo1]}>Restante: 6</Text>

      <Text style={[styles.price2, styles.pricePosition1]}>R$ 6,97</Text>

      <Text style={[styles.restaurantName, styles.restaurantTypo]}>Galinha Caipira 69g</Text>

      <Text style={[styles.paoVisconti, styles.poViscontiTypo]}>Pão Visconti</Text>

      <Text style={styles.tradicional400g}>Tradicional 400g</Text>

      <Text style={[styles.salgadinhoDoritos, styles.poViscontiTypo]}>Salgadinho DORITOS</Text>

      <Text style={[styles.restante6, styles.restanteFlexBox]}>Restante: 6</Text>
      ...
      <Text style={[styles.chocolateSnickers, styles.cervejaHeinekenTypo]}>Chocolate SNICKERS</Text>
      ...
      <Text style={[styles.restaurantName3, styles.restaurantPosition]}>Original 45g</Text>
      ...
      <Text style={[styles.cervejaHeineken, styles.cervejaHeinekenTypo]}>Cerveja HEINEKEN</Text>
      ...
      <Text style={[styles.restaurantName4, styles.restaurantPosition]}>Lata 350ml</Text>
      ...
      <Text style={[styles.energticoMonster, styles.cupNoodlesTypo]}>Energético MONSTER</Text>

      <Text style={[styles.restante12, styles.restanteTypo1]}>Restante: 12</Text>

      <Text style={[styles.price5, styles.pricePosition]}>R$ 11,59</Text>

      <Text style={[styles.textoLata437ML, styles.restaurantTypo]}>Lata 473ml</Text>

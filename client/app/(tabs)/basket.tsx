...
const Basket = () => {
  ...
  return (
    <View style={styles.basket}>
      ...
      <Text style={[styles.precoTotal, styles.totalClr]}>R$ 53,18</Text>
      ...
      <Text style={[styles.nomeEsvaziarCesta, styles.esvaziarCestaTypo]}>Esvaziar cesta</Text>
      ...
      <Text style={[styles.nomeEnergeticoMonster, styles.nomeDosProdutos]}>Energetico Monster</Text>

      <Text style={[styles.precoEnergeticoMonster, styles.r697Typo]}>R$ 11,59</Text>

      <Text style={[styles.descricaoEnergeticoMonster, styles.lata350mlTypo]}>Lata 350ml</Text>
      ...
      <Text style={[styles.numero3EnergeticoMonster, styles.textTypo]}>3</Text>

      <Text style={[styles.numero2CupNoodles, styles.textTypo]}>2</Text>
      ...
      <Text style={[styles.nomeCupNoodles, styles.nomeDosProdutos]}>Cup Noodles</Text>

      <Text style={[styles.precoCupNoodles, styles.r697Typo]}>R$ 6,97</Text>

      <Text style={[styles.descricaoCupNoodles, styles.lata350mlTypo]}>Galinha caipira 69g</Text>
      ...
      <Text style={[styles.nomeChocolateSnickers, styles.nomeDosProdutos]}>Chocolate SNICKERS</Text>

      <Text style={styles.precoChocolateSnickers}>R$ 4,47</Text>

      <Text style={[styles.descricaoChocolateSnickers, styles.lata350mlTypo]}>Original 45g</Text>
      ...
      <Text style={[styles.numero1Snickers, styles.textTypo]}>1</Text>

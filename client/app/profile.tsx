  ...
  return (
    <View style={ styles.profile1 }>
      ...
      <View style={ styles.johnParent }>
        ...
        <Text style={ [styles.john, styles.johnLayout] }>
          John
        </Text>
      ...
      <View style={ styles.groupParent }>
        ...
        <View style={ styles.nomeParent }>
          ...
          <Text style={ [styles.nome, styles.nomeFlexBox] }>
            Nome
          </Text>

          <View style={ styles.groupChild } />

          <Text style={ [styles.johnDoe, styles.text1Typo] }>
            John Doe
          </Text>
        ...
        <Text style={ [styles.telefone, styles.eMailTypo] }>
          Telefone
        </Text>
      ...
      <Text style={ [styles.desejaExcluirSuaContainer, styles.editeInformaesDeTypo] }>
        ...
        <Text style={ styles.desejaExcluirSuaConta }>
          ...
          <Text style={ styles.desejaExcluirSua }>
            Deseja excluir sua conta?
          </Text>

          <Text style={ styles.nomeTypo }>
            {` `}
          </Text>

        </Text>

        <Text style={ [styles.cliqueAqui, styles.textTypo] }>
          Clique aqui!
        </Text>
      ...
      <Text style={ [styles.sair, styles.nomeFlexBox] }>
        Sair
      </Text>

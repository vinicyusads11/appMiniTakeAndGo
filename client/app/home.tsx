...
const Home = () => {
  return (
    <View style={styles.home}>
      ...
      <Text style={[styles.poVisconti, styles.poViscontiTypo]}>Pão Visconti</Text>
      ...
      <Text style={[styles.restaurantName5, styles.restaurantTypo]}> Lata 473ml</Text>
      <Image
      ...
      />
      <Image style={styles.icon} contentFit="cover" source={require('../assets/searchicon.png')} />

...
const Payment = () => {
  return (
    <View style={styles.payment}>
      <Text style={styles.brgovbcbpix256}>
        02020303012923013br.gov.bcb.pix256..
      </Text>
      <Text
        style={[
          styles.instruesParaFinalizarAContainer,
          styles.copiarCdigoPixPosition,
        ]}
      >
      ...
      <Text style={[styles.pixCopiaE, styles.button1Typo]}>
        Pix Copia e Cola
      </Text>
      <Text style={[styles.restaurantName, styles.totalFlexBox]}>
        Código Pix Copia e Cola
      </Text>
      <View style={[styles.button, styles.buttonPosition]}>
        <Text style={[styles.button1, styles.button1Typo]}>Pagar</Text>
      </View>
      <Text style={[styles.copiarCdigoPix, styles.copiarCdigoPixPosition]}>
        Copiar código PIX
      </Text>
      <Image

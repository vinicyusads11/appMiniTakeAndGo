...
const Login = () => {
  return (
    <View style={styles.login}>
      ...
      />
      <Text style={[styles.continuarComGoogle, styles.button1Typo1]}>
      ...
      />
      <Text style={[styles.esqueciMinhaSenha, styles.placeholderTypo]}>
        Esqueci minha senha
      </Text>
      <Pressable style={styles.button} onPress={() => {}}>
        <Text style={[styles.button1, styles.button1Typo]}>Entrar</Text>
      </Pressable>
      <Text style={[styles.entreNaSua, styles.button1Typo]}>
        Entre na sua conta
      </Text>
    </View>
  );
